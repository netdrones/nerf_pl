train-house: download-house
	sh +x bin/train.sh house house_scale1_nerfw 1

train-playground: download-playground
	sh +x bin/train.sh playground playground_scale1_nerfw 1

train-truck: doownload-truck
	sh +x bin/train.sh truck truck_scale1_nerfw 1
